...
int m_localplayer = 0x22245c0 + 0x8;            //.?AVC_GameMovement@@ + 0x8)
...
#define in_Attack 0x07472f98                     //[Buttons] -> in_attack
#define m_bleedoutState 0x2790
//#define OFFSET_YAW 0x22ec                      //m_currentFramePlayer.m_ammoPoolCount
